...
public static class ItemCollection {
    ...
    public static void CompileItemList() {
        ...
        ItemDataSet = new() {
            ...
            new(2, "Orange", typeof(Orange), GD.Load<Texture2D>("Images/Items/orange.png"), ItemCategories.NONE, ItemPools.Treasure, "You feel healthy!"),
            ...
            new(5, "Not Brimstone", typeof(NotBrim), GD.Load<Texture2D>("Images/Items/notBrimstone.png"), ItemCategories.NONE, ItemPools.Treasure, "Purple Beam Barrage")
        };
